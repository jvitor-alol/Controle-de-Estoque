...
namespace controleEstoque
{
    public class Metodos
    {
        ...
        public static void novoFilme(List<Filme> estoqueFilmes, ref int idAdicional)
        {
        ...
        public static void listarFilmes(List<Filme> estoqueFilmes)
        {
        ...
        public static void removerFilmes(List<Filme> estoqueFilmes)
        {
        ...
        public static void entradaEstoque(List<Filme> estoqueFilmes)
        {
        ...
        public static void saidaEstoque(List<Filme> estoqueFilmes)
        {
